...
* AFF A900 systems only support high-line power (200V-240V). If the AFF A700 system is running on low-line power (100V-140V), its input power must be converted before using  this procedure.
