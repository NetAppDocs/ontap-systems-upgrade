...
summary: Learn about using aggregate relocation to upgrade AFF, ASA, or FAS controller hardware.
---
= Start here: Choose your ARL upgrade procedure for AFF, ASA, or FAS controller hardware
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
You can upgrade AFF, ASA, or FAS controller hardware without disruption by using aggregate relocation (ARL). For other methods of upgrading your controller hardware, see link:../upgrade/upgrade-decide-to-use-this-guide.html[Upgrade by moving volumes or storage].
...
If your upgrade scenario is listed in the following supported systems matrix, go to link:../upgrade-arl-auto-app-9151/index.html[Use "system controller replace" commands to upgrade to controller hardware introduced in ONTAP 9.15.1 or later] to start the upgrade procedure. 
...
If your upgrade scenario is listed in the following supported systems matrix, go to link:../upgrade-arl-auto-in-chassis/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis] to start the upgrade procedure.
