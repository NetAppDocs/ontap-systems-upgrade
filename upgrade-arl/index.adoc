...
If your upgrade scenario is listed in the following supported systems matrix, go to link:../upgrade-arl-auto-app-9151/index.html[Use "system controller replace" commands to upgrade controller hardware introduced in ONTAP 9.15.1] to start the upgrade procedure. 
