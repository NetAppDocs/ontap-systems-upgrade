...
If your upgrade scenario is listed in the following supported systems matrix, go to link:../upgrade-arl-auto-app-9151/index.html[Use "system controller replace" commands to upgrade controller hardware running ONTAP 9.15.1 or later] to start the upgrade procedure. 
...
* link:../upgrade-arl-manual-app/index[Manually upgrade controller hardware running ONTAP 9.8 or later]
