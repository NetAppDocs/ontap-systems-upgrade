...
Controller upgrades are supported for certain system configurations. To view the list of supported systems and minimum ONTAP versions, link:decide_to_use_the_aggregate_relocation_guide.html#supported-systems,[Supported system upgrade combinations].
