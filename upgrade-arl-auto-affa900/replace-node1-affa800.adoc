...
. [[a90_push_drives_node1]]On the front of the chassis, use your thumbs to firmly push *each* drive in to the top and bottom disk bays until you feel a positive stop. This ensures that the drives are firmly seated against the chassis midplane.
+
image:drw_a800_drive_seated_IEOPS-960.png[Push drive to firmly seat against the chassis midplane]
...
+
`saveenv`
.  Repeat <<a90_push_drives_node1, Step 3>> to firmly push each drive in until you feel a positive stop.  This is to ensure that any drives that were unseated during the installation of the new controller are firmly seated.
