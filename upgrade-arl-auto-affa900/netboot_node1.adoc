...
. (AFF A250 and AFF C250 upgrades only) When node1 for the replacement controller module is booting, the following warning displays:
+
----
*****************************************************
...
Answer `y`.
+
This warning displays because the configuration includes node2 for the existing controller. It displays for every system boot until you upgrade node2. This is the expected behavior.
