...
.	Wait for the node1 now running on the AFF A70, AFF A90, ASA A900, AFF A900, or FAS9500 controller module to boot and display the boot menu options as shown below:
+
----
