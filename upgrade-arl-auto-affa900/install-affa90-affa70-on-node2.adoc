...
---
= Install the AFF A30, AFF A50, AFF C30, or AFF C60 module on node2
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Install the AFF A30, AFF A50, AFF C30, or AFF C60 controller module that you received for the upgrade on node2. Node2 is controller B located on the right side of the chassis when looking at the controllers from the rear of the system.
