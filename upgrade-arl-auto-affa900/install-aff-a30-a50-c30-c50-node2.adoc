...
+
`saveenv`
. For two node switchless configurations, verify that you have an X60132A in slot1 on node2. The X60132A card is required for cluster interconnect during the upgrade.
