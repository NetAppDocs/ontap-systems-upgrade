...
[.lead]
Node1 with the replacement modules is now ready to boot. This section provides the steps required to boot node1 with the replacement modules listed in the <<supported-systems,supported systems matrix>>.
