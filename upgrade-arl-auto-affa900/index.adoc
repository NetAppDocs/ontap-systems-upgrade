...
* The AFF A250 and AFF C250 systems use 10/25 GbE onboard ports for cluster interconnect. To upgrade the two node switchless clusters of an AFF A250 or AFF C250 system to an AFF A50, AFF A30, AFF C60, or AFF C30 system, you must use an X60132A 10/25 GbE card in slot1. This provides cluster interconnect for cluster LIFs to a temporary port on the target platform. 
+
Details on the additional steps needed for upgrading from A250 and C250 are provided in this document in corresponding sections.
