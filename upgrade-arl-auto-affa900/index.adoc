...
[.lead]
This procedure describes how to nondisruptively upgrade controller hardware on a HA pair using aggregate relocation (ARL) for the following system configurations. The procedure converts the existing system to the replacement system, keeping the old system chassis and disks. 
...
|===
|On the existing system... |Perform the following...
|AFF A800
|Swap the two AFF A800 controllers and all I/O modules with the new controllers and I/O modules.
