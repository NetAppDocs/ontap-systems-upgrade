...
For AFF A250, AFF C250, AFF A800, or AFF C800 upgrades only, you map the physical ports from the existing node1 to the replacement node1 because the physical ports are changing between the existing and replacement controllers. There is no change to the physical ports on the other systems supported by this upgrade procedure. 
