...
summary: "Configure node4 onboard FC ports, UTA and UTA2 ports, or UTA and UTA2 card during a manual ARL upgrade on controllers running ONTAP 9.7 or earlier."
---
