...
Refer to link:other-references.html[References] to link to the _MetroCluster Management and Disaster Recovery_ content and follow the procedures for negotiated switchover, healing, and switchback.
