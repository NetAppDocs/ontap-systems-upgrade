...
+
NOTE: If your upgrading AFF A800, you can also upgrade by aggregate relocation. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html[Learn more^]
