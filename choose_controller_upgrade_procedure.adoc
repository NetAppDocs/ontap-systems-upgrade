...
| Do I still need to validate SAN zoning on all nodes in the cluster on the original and replacement system?
...
| Do I still need to validate SAN zoning on all nodes in the cluster on the original and replacement system?
| No. I have already validated SAN zoning on all nodes in the cluster on both systems. 
