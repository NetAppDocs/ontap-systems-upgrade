...
+
NOTE: You can also upgrade an AFF A800 to an AFF A70, AFF A90, or AFF A1K by using aggregate relocation. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html[Learn more].
