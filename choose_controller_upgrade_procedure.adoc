...
In a modular system, the controller does not have any internal disks and all storage is externally attached shelves.
...
In an integrated system, the controller has internal disks and the storage is contained within the controller chassis.
