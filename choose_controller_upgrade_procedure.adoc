...
* link:upgrade/upgrade-decide-to-use-this-guide.html[Move storage]
+
You can non-disruptively upgrade from an AFF A250 to an AFF A400 or a FAS2820 to a replacement system by converting the original nodes to drive shelves, then connecting the drive shelves to the replacement nodes to move onboard storage.
