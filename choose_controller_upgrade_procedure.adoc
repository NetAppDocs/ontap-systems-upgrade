...
+
You can perform a non-disruptive upgrade by converting the original system to a controller shelf and moving the storage to the replacement system for an AFF A250 to AFF A400 or a FAS2820 upgrade.
