...
[cols=2*,options="header",cols="30,70"]
|===
| Ask yourself…	| If your answer is yes, you need to do this…
...
| Does an FC SAN configuration exist on the cluster of my original system?
| Yes. I have validated the SAN zoning configuration on all nodes on both the original and replacement systems.
