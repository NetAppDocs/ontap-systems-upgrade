...
+
You can non-disruptively upgrade from an AFF A250 to an AFF A400 or a FAS2820 to a replacement system by converting the original nodes to a controller shelf, then moving storage by connecting the controller shelf to the replacement nodes.
