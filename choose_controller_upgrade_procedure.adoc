...
+
You can non-disruptively upgrade from an AFF A250 to an AFF A400 or a FAS2820 to a replacement system by converting the original system to a controller shelf and then moving the storage to the replacement system.
