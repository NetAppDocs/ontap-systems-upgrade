...
[.lead]
If any aggregates fail to relocate or are vetoed, you must take manually relocate the aggregates to node2, or override either the vetoes or destination checks, if necessary.
