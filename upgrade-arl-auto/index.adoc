...
* If you are upgrading from an AFF A320 system, you can use volume moves to upgrade controller hardware or contact technical support. If you are willing to do volume moves, refer to link:other-references.html[References] to link to _Upgrade by moving volumes or storage_.
