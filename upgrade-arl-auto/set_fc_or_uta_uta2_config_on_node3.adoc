...
+
* If node3 has a UTA/UTA2 card or UTA/UTA2 onboard ports, go to <<check-config-uta-uta2-node3,Check and configure UTA/UTA2 ports on node3>>.
* If node3 doesn't have a UTA/UTA2 card or UTA/UTA2 onboard ports, skip <<check-config-uta-uta2-node3,Check and configure UTA/UTA2 ports on node3>> and go to link:reassign-node1-disks-to-node3.html[Reassign node1 disks to node3].
