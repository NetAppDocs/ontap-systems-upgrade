...
[start=8]
. If the system that you are upgrading has storage disks, perform one of the following actions:
+
...
[start=12]
. [[auto_check3_step12]]If the system has storage disks, go to link:reassign-node1-disks-to-node3.html[Reassign node1 disks to node3]. 
