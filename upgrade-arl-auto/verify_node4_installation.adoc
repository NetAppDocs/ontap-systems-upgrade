...
+
CAUTION: At this stage, the MetroCluster configuration is not in a normal state and you might have errors to resolve. See link:verify_health_of_metrocluster_config.html[Verify the health of the MetroCluster configuration].
...
For more information on creating and re-creating VLANs, interface groups, and broadcast domains, go to link:other-references.html[References] and link to _Network Management_.
