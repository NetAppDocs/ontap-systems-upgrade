...
+
Refer to link:other_references.html[References] to link to _Network Management_ or the _ONTAP 9 Command reference_ and see _Configuring failover settings on a LIF_ for more information.
