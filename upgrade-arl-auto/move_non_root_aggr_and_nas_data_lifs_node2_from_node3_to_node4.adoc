...
+
If any aggregates fail to relocate or are vetoed, you must take manually relocate the aggregates, or override either the vetoes or destination checks, if necessary. See the section link:relocate-failed-or-vetoed-aggr-node2.html[Relocate failed or vetoed aggregates] for more information.
