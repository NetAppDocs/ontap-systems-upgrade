...
`boot_ontap menu`
+
If you do not have an FC or UTA/UTA2 configuration, perform link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1[Reassign node1 disks to node3, Step 1] so that node3 can recognize node1’s disks.

. [[auto9597_istall3_step29]]For a MetroCluster configuration,
go to link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1[Reassign node1 disks to node3, Step 1].
