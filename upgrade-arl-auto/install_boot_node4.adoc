...
`boot_ontap menu`
+
If you do not have an FC or UTA/UTA2 configuration, perform link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1[Reassign node2 disks to node4, Step 1] so that node4 can recognize node2’s disks.

. [[step29]] For MetroCluster configurations, go to link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1[Reassign node2 disks to node4, Step 1].
