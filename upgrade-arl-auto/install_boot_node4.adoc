...
. [[step29]] For MetroCluster configurations, V-Series systems, and systems with FlexArray Virtualization software connected to storage arrays, go to link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1[Reassign node2 disks to node4, Step 1].
