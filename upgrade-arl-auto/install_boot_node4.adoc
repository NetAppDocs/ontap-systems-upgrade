...
* If you have a system with an FC or UTA/UTA2 configuration, link:set_fc_or_uta_uta2_config_node4.html[set the FC or UTA/UTA2 configuration on node4].

* If you don't have an FC or UTA/UTA2 configuration, link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1[reassign node2 disks to node4, Step 1] so that node4 can recognize node2’s disks.

* If you have a MetroCluster configuration, link:set_fc_or_uta_uta2_config_node4.html[set the FC or UTA/UTA2 configuration on node4] to detect the disks attached to the node.
