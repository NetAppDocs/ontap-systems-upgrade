...
---
= Set the FC or UTA/UTA2 configuration on node3 (ONTAP 9.8 or later, automated)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
| Go to <<check-config-uta-uta2-node3,Check and configure UTA/UTA2 ports on node3>>
