...
* If you are upgrading from an AFF A320 system, you can use volume moves to upgrade controller hardware or contact technical support. Refer to link:other-references.html[References] to link to _Upgrade by moving volumes or storage_.
...
.What's next?
After learning about this ARL procedure, link:decide_to_use_the_aggregate_relocation_guide.html[decide whether to use this ARL procedure].
