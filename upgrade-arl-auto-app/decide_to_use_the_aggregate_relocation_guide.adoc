...
^1^For the additional steps needed for AFF A800 systems, go to the step that references A800 in section link:reassign-node1-disks-to-node3.html#reassign-node1-node3-app-step9[Reassign node1 disks to node3, Step 9], or link:set_fc_or_uta_uta2_config_node4.html#auto_check_4_step23[Check and configure UTA/UTA2 ports on node4, Step 23].
