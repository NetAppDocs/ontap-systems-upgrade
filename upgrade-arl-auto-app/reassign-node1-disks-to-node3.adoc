...
* Go to section link:verify_node3_installation.html[Verify the node3 installation]
...
.What's next?
After reassigning node1 disks to node3, link:verify_node3_installation.html[verify the node3 installation].
