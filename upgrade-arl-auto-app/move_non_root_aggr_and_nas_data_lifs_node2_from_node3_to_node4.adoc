...
. If necessary, restore and revert displaced LIFs or manually relocate LIFs that failed to relocate automatically.
+
[role="tabbed-block"]
====
...
.Manually relocate LIFs
--
Manually relocate LIFs to node4 that failed to relocate automatically: 

`aggr relocation start -node cluster-02 -destination cluster-01 -aggregate-list n01_aggr1 -override-vetoes true`
`
--
====
