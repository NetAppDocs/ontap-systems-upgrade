...
+
Enter the passphrase and the backup information that you recorded earlier in the procedure. See link:complete-preparation-for-upgrade.html#manage_storage_encryption_using_okm[Manage storage encryption using the Onboard Key Manager].
