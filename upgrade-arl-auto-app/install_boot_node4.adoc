...
`boot_ontap menu`
+
If you don't have an FC or UTA/UTA2 configuration, execute link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step1[Reassign node2 disks to node4, Step 1] so that node4 can recognize node2's disks.
