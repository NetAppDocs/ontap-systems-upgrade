...
[start=8]
. [[step8]]If the system that you are upgrading has storage disks, go to link:reassign-node2-disks-to-node4.html[Reassign node2 disks to node4] if node4 does not have a UTA/UTA2 card or UTA/UTA2 onboard ports.

include::../_include/ru_auto_check_config_uta_uta2_ports_node4_intro_step_11.adoc[]

[start=12]
. [[step12]]If the system has storage disks, go to link:reassign-node2-disks-to-node4.html[Reassign node2 disks to node4].
