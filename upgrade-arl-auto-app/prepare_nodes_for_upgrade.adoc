...
NOTE: If NetApp Aggregate Encryption (NAE) or NetApp Volume Encryption (NVE) using Onboard Key Manager (OKM) is in use, keep the key manager passphrase ready to complete the key manager resync later in the procedure.
