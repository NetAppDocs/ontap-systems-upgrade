...
.What's next?
After verifying the health of the MetroCluster configuration, link:check_for_metrocluster_config_errors.html[check for MetroCluster configuration errors].
