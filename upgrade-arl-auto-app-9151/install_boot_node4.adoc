...
summary: "Install and boot node4 and install ONTAP software when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
