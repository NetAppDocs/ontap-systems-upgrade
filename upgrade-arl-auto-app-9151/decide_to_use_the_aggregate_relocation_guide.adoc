...
* You are upgrading an AFF A800 to an AFF A70 or AFF A90. To perform this AFF A800 upgrade, see see link:other_references.html[References] to link to _Use "system controller replace" commands to upgrade controller models in the same chassis_.
