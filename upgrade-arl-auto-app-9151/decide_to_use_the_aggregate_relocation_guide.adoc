...
* If you're performing one of the following upgrades:
+
|===
...
[NOTE]
====
The  AFF A20, AFF A30, AFF A50, AFF A70, AFF A90, AFF A1K, AFF C30, AFF C60, and AFF C80 are integrated systems with two controllers in an HA configuration and onboard disks in a single chassis. 
