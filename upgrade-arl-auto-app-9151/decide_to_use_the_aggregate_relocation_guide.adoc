...
To upgrade an AFF A800 to and AFF A70 or AFF A90, see link:../upgrade-arl-auto-affa900/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis].
====
