...
There are several ARL methods for upgrading controller hardware. This ARL procedure supports controller upgrades for systems introduced in ONTAP 9.15.1 or later. To help you decide if this ARL procedure is correct for your hardware upgrade configuration, review all the following considerations. 

== Considerations for using ARL
You can upgrade a pair of nodes using this ARL procedure under the following circumstances:
...
** Your hardware upgrade configuration is listed in the <<sys_commands_9151_supported_systems,supported model matrix>>.
...
You cannot upgrade a pair of nodes using this ARL procedure under the following circumstances:
...
The following table shows the supported controller upgrade combinations using ARL for systems introduced in ONTAP 9.15.1 or later. If your controller upgrade combination is not listed, contact technical support.
