...
* If you are upgrading to an AFF A70 or AFF A90 with internal drives, before you upgrade, you must remove ownership of these drives. After completing the upgrade, you can assign the internal drives to the AFF A70 or AFF A90 nodes and use them for creating data aggregates. It is not mandatory to migrate root or data aggregates to internal drives.
