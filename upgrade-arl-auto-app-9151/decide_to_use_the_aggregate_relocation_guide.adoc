...
There are several ARL methods for upgrading controller hardware. This ARL procedure supports controller upgrades for systems introduced in ONTAP 9.15.1 or later. You should review all the following considerations to help you decide if this ARL procedure supports your controller hardware upgrade.  
