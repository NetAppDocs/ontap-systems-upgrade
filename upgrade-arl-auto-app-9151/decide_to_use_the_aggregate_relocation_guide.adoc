...
[NOTE]
====
The AFF A70 and AFF A90 are integrated systems with onboard disks and the two controllers and disks are in a single chassis. 

* If you are upgrading to an AFF A70 or AFF A90 with internal drives, before you upgrade, you must remove ownership of these drives. After completing the upgrade, you can assign these internal drives to the AFF A70 or AFF A90 nodes and use them for creating data aggregates. It is not mandatory to migrate root or data aggregates to internal drives.
* If you are upgrading to an AFF A70 or AFF A90 without internal drives, after completing the upgrade, you don't need to assign internal drives. 
