...
* You are upgrading a V-series system or FlexArray Virtualization storage system using an external array for backend storage. Contact NetApp for options to upgrade a V-series or FlexArray system.
