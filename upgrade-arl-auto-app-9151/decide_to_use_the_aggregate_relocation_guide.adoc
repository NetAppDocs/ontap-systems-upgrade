...
[.lead]
There are several aggregate relocation (ARL) methods for upgrading controller hardware. This ARL procedure supports controller upgrades for AFF and FAS storage systems introduced in ONTAP 9.15.1 or later. 

== Considerations for using this ARL procedure
...
You should review all the following circumstances to help you decide if this ARL procedure supports your controller hardware upgrade.

=== Supported for this ARL procedure
...
=== Unsupported for this ARL procedure
