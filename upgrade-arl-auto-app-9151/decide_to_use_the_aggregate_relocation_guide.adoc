...
* You are upgrading an AFF A800 to an AFF A70 or AFF A90. For this AFF A800 upgrade scenario, see link:../upgrade-arl-auto-affa900/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis].
* You are upgrading a V-series system or FlexArray Virtualization storage system using an external array for backend storage. Contact NetApp for options to upgrade a V-series or FlexArray systems.
