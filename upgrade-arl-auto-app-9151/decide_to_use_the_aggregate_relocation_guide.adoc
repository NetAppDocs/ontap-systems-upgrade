...
* You are upgrading an AFF A800 to an AFF A70 or AFF A90. To perform this AFF A800 upgrade, see link:https://review.docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-affa900/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis].
