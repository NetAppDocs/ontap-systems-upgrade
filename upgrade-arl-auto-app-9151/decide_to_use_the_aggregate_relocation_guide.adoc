...
|===
^1^ To upgrade to an AFF A20, you must first convert an AFF A150 or AFF A220 to a DS224C shelf by swapping controller module with an IOM12 module. See link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade/upgrade-convert-node-to-shelf.html[Convert an original node to a drive shelf].

[NOTE]
====
The  AFF A20, AFF A30, AFF A50, AFF A70, AFF A90, AFF C30, AFF C60, and AFF C80 are integrated systems with two controllers in an HA configuration and onboard disks in a single chassis. 

* If you are upgrading to an AFF A20, AFF A30, AFF A70, AFF A90, AFF C30, or AFF C60 with internal drives, you must remove ownership of these internal drives before you upgrade. After completing the upgrade, you can assign the internal drives to the AFF A20, AFF A30, AFF A70, AFF A90, AFF C30, or AFF C60 nodes and use them for creating data aggregates. It is not mandatory to migrate root or data aggregates to internal drives.
* If you are upgrading to an AFF A20, AFF A30, AFF A70, AFF A90, AFF C30, or AFF C60 without internal drives, you don't need to assign internal drives after completing the upgrade.  
