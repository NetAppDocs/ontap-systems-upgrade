...
== Considerations when deciding to use ARL
...
The following table shows the supported controller upgrades using ARL for systems introduced in ONTAP 9.15.1 or later.
...
== Choose a different upgrade procedure
