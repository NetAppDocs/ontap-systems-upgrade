...
* You are upgrading an AFF A800 to an AFF A70 or AFF A90. To perform this AFF A800 upgrade, see link:../upgrade-arl-auto-affa900/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis].
* You are upgrading a V-series system or FlexArray Virtualization storage system using an external array for backend storage. Contact NetApp support for options to upgrade a V-series or FlexArray system.
