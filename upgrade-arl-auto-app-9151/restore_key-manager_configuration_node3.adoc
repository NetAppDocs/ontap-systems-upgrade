...
summary: "If required, restore key-manager configuration on node3 when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
