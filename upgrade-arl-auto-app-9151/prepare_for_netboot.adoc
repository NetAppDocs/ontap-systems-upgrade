...
* Refer to link:other-references.html[References] to link to the _NetApp Support Site_ and download the necessary system files for your platform and the correct version of ONTAP.
...
.What's next?
After preparing for netboot, link:install_boot_node3.html[install and boot node3].
