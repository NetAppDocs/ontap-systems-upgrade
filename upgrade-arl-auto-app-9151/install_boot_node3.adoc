...
summary: "Install and boot node3 and install ONTAP software when upgrading controllers introducced ONTAP 9.15.1 or later by using `system controller replace` commands."
---
