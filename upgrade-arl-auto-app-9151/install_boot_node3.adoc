...
summary: "Install and boot node3 and install ONTAP software when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
