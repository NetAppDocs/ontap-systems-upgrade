...
summary: "Verify that the node1 NAS data LIFs on node2 are relocated from node2 to node3 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
