...
summary: "Move non-root aggregates and NAS data LIFs from node1 to node2 and move node1's resources to node3 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
