...
summary: "Verify that node2's physical ports map correctly to node4 and restore network configuration on node4 when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
