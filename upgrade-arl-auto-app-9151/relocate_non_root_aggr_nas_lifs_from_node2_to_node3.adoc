...
summary: "Relocate node2's non-root aggregates to node3 when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
