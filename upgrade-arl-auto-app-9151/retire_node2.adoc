...
summary: "Shut down node2 and remove it from the rack or chassis when upgrading to controllers introduced in ONTAP 9.15.1 or later by using `system controller replace` commands."
---
= Retire node2
:hardbreaks:
:nofooter:
...
.What's next?
After retiring node2, link:install_boot_node4.html[install and boot node4].
