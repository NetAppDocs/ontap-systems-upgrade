...
summary: "Shut down node2 and remove it from the rack or chassis when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
= Retire node2
:hardbreaks:
:nofooter:
