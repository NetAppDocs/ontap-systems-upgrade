...
summary: "If required, restore key-manager configuration on node4 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
