...
summary: "The system might crash – reboot, panic, or go through a power cycle – during different stages when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
