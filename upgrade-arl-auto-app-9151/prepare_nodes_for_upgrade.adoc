...
[source,cli]
----
network interface show -curr-node <local> -role <cluster,
----
+
[source,cli]
----
intercluster,node-mgmt,cluster-mgmt,data>
----
+
[source,cli]
----
...
halt
---- 
.. Install a DARE image. For more information, refer to see the Knowledge Base article link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/Netbooting_a_FAS_and_AFF_Controller_in_ONTAP_9[Netbooting a FAS and AFF Controller in ONTAP 9^].
