...
summary: "Prepare the nodes and run a series of prechecks when upgrading controllers introducced ONTAP 9.15.1 or later by using `system controller replace` commands."
---
