...
+
----
Cluster ::> reachability repair -node node1_node3 -port e2a
----
+
----
Warning: Repairing port "node1_node3: e2a" may cause it to move into a different broadcast domain, which can cause LIFs to be re-homed away from the port. Are you sure you want to continue? {y|n}:
----
+
