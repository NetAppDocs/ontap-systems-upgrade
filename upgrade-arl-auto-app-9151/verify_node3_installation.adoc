...
summary: "Verify that the node1 physical ports map correctly to node3 and restore network configuration on node3 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
