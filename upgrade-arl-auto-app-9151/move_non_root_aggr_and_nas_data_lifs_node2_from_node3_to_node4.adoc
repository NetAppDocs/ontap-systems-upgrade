...
summary: "Verify that node2's NAS data LIFs that are on node3 are relocated from node3 to node4 when upgrading controllers introducced ONTAP 9.15.1 or later by using `system controller replace` commands."
---
