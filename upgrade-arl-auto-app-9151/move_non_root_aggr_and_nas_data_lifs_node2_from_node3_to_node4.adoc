...
summary: "Verify that node2's NAS data LIFs that are on node3 are relocated from node3 to node4 when upgrading to controllers introduced in ONTAP 9.15.1 or later by using `system controller replace` commands."
---
