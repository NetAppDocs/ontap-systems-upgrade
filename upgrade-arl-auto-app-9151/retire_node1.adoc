...
summary: "Disable the HA pair with node2 and shut down node1 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
= Retire node1
:hardbreaks:
:nofooter:
