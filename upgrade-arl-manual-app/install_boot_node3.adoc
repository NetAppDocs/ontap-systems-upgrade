...
---
= Install and boot node3 (ONTAP 9.8 or later, manual)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
Enter the passphrase and the backup information that you recorded earlier in the procedure. See link:manage_authentication_okm.html[Manage authentication keys using the Onboard Key Manager].
include::../_include/ru_man_install_boot_node3_steps_17_to_48.adoc[]

.What's next?
After installing and booting node3, link:set_fc_uta_uta2_config_node3.html[set the FC or UTA/UTA2 configuration on node3].
