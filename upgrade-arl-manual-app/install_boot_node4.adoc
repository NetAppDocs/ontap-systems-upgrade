...
---
= Install and boot node4 (ONTAP 9.8 or later, manual)
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.What's next?
After installing and booting node4, link:set_fc_uta_uta2_config_node4.html[set the FC or UTA/UTA2 configuration on node4].
