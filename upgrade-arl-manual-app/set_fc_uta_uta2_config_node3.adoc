...
* If node3 does not have onboard FC ports, onboard UTA/UTA2 ports, or a UTA/UTA2 card (for example, AFF and FAS systems introduced in ONTAP 9.15.1), and you are upgrading a system with storage disks, you can skip to the link:map_ports_node1_node3.html[Map ports from node1 to node3].
