...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-7.png[Seven]link:upgrade-remove-original-nodes-move-volumes.html[Remove the original nodes from the cluster]
[role="quick-margin-para"]
