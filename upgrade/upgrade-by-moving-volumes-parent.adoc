...
[.lead]
Upgrading controller hardware by moving volumes is a nondisruptive procedure. Before starting your upgrade, familiarize yourself with the general upgrade scenarios and upgrade considerations:
