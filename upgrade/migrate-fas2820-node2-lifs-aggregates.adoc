...
[NOTE]
====
* You need to netboot and install the ONTAP version on node3 and node4 to match the ONTAP version on the FAS2820 systems.
...
* You have all the correct cabling available.
