...
summary: After converting AFF A150, AFF A220, or FAS2820 node1 to a drive shelf and connecting to node3, you reassign the drives that previously belonged to node1 to node3.
---
...
[.lead]
Reassign the drives that were previously assigned to AFF A150, AFF A220, or FAS2820 node1 to node3.
