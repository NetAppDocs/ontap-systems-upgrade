...
summary: After converting node1 to a drive shelf and connecting to node3, you reassign the drives that previously belonged to node1 to node3.
---
...
link:migrate-node4-lIfs-aggregates.html[Migrate LIFs and data aggregates on node4 to node3]
