...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html[Learn about converting AFF A250 to a drive shelf and moving storage to AFF A400] (nondisruptive procedure)
* link:convert-to-drive-shelf.html[Upgrade from AFF A150, AFF A220, or FAS2820 by converting to a drive shelf] (nondisruptive procedure)
