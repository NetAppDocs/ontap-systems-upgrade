...
[.lead]
You can nondisruptively upgrade a NetApp FAS2820 system by moving storage. During the upgrade procedure you convert each FAS2820 node to a DS212C drive shelf and then connect to the replacement nodes.
...
.About this task
In this procedure, the FAS2820 high-availability (HA) pair controllers are called node1 and node2, and the replacement HA pair controllers are called node3 and node4.
