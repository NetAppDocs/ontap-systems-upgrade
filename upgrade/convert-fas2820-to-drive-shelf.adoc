...
[.lead]
Perform a nondisruptive upgrade of a NetApp FAS2820 system by converting each node to a DS212C drive shelf. Then, connect the drive shelves to the replacement nodes. This moves the FAS2820 onboard storage to the replacement system.
...
[role="quick-margin-para"]
Convert FAS2820 node2 to a DS212C drive shelf and then connect to node4 before reassigning drives from node2 to node4.
...
[role="quick-margin-para"]
After converting FAS2820 node1 to a DS212C drive shelf and connecting to node3, reassign the drives that previously belonged to node1 to node3.
