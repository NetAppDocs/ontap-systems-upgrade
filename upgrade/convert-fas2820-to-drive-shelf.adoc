...
[.lead]
Perform a nondisruptive upgrade of a NetApp FAS2820 by converting each node to a DS212C drive shelf. Then, connect the drive shelves to the replacement nodes. This moves the FAS2820 onboard storage to the replacement system.
