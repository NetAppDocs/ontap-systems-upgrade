...
---
= Learn about upgrading by moving storage
:icons: font
:imagesdir: ../media/
...
.What's next?
After learning about upgrading by moving storage, link:upgrade-prepare-when-moving-storage.html[prepare for the upgrade].
