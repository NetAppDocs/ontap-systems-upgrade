...
[.lead]
Upgrading controller hardware by moving storage is a disruptive procedure. Before starting your upgrade, familiarize yourself with the general upgrade scenarios and upgrade considerations:
