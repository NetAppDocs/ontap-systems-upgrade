...
. [[ressign-spare-disks-step9]]Exit Maintenance mode:
+
`halt`

. Repeat <<ressign-spare-disks-step1,Step 1>> to <<ressign-spare-disks-step9,Step 9>> on node4.
