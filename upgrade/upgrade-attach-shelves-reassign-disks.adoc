...
. Connect the storage shelf cables from the shelves that were previously attached to node1 to node3 and node2 to node4. 
+
...
.Reassign to node3
--
Reassign node1's spare disks to node3, disks belonging to the root aggregate, and any data aggregates to node3:
...
.Reassign to node4
--
Reassign node2's spare disks to node4, disks belonging to the root aggregate, and any data aggregates to node4:
