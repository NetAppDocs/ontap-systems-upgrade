...
.What's next?
After moving internal drives from the original node, link:upgrade-attach-shelves-reassign-disks.html[attach storage shelves and reassign disk ownership].
