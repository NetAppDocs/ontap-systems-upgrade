...
summary: After converting AFF A150, AFF A220, or FAS2820 node2 to a drive shelf and connecting to node4, you reassign the drives that previously belonged to node2 to node4.
---
...
[.lead]
Reassign the drives that previously belonged to AFF A150, AFF A220, or FAS2820 node2 to node4.
