...
summary: After converting node2 to a drive shelf and connecting to node4, you reassign the drives that previously belonged to node2 to node4. 
---
...
[.lead]
Reassign the drives that previously belonged to node2 to node4.
...
link:migrate-aggregates-epsilon-lifs.html[Migrate data aggregates, epsilon, and LIFs on node1 to node4]
