...
[.lead]
Migrate the data aggregates, epsilon, and logical interfaces (LIFs) on node1 to node4.
...
link:convert-node1-to-drive-shelf.html[Convert node1 to a drive shelf and connect to node3]
