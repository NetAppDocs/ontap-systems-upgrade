...
. If the new nodes have FC ports (onboard or on FC adapters), onboard CNA ports, or a CNA card, configure the FC or NCA ports, enter the following command from the storage system prompt:
+
