...
summary: After converting FAS2820 node1 to a DS212C drive shelf and connecting to node3, you reassign the drives that previously belonged to node1 to node3.
---
