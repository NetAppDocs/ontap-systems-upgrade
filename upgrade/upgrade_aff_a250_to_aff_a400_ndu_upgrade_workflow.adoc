...
[.lead]
Perform a nondisruptive upgrade from an AFF A250 system to an AFF A400 system by moving storage. Convert each AFF A250 node to an NS224 drive shelf, then connect to the AFF A400 replacement nodes.
