...
[.lead]
You can nondisruptively upgrade from a NetApp AFF A250 system to an NetApp AFF A400 system by moving storage. During the upgrade procedure you convert each AFF A250 node to an NS224 drive shelf and then connect to the AFF A400 replacement nodes.
