...
[.lead]
Perform a nondisruptive upgrade from an AFF A250 system to an AFF A400 system by converting the AFF A250 nodes to NS224 drive shelf. Then, connect them to the AFF A400 replacement nodes. This moves the AFF A250 onboard storage to the AFF A400 replacement system.
