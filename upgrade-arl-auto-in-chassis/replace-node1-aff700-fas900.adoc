...
---
= Replace node1 AFF A700 or FAS9000 controller and NVRAM modules
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Replace the node1 AFF A700 or FAS9000 controller and NVRAM modules with ASA A900, AFF A900, or FAS9500 controller and NVRAM modules.
...
Detach and remove the node1 AFF A700 or FAS9000 controller module.
...
Unlock and remove the node1 AFF A700 or FAS9000 NVRAM module.
...
Install, cable, and connect the ASA A900, AFF A900, or FAS9500 NVRAM module in node1.
...
Install, cable, and connect the ASA A900, AFF A900, or FAS9500 controller module in node1.
...
.What's next?
After installing the ASA A900, AFF A900, or FAS9500 controller and NVRAM modules, link:netboot-node1.html[netboot node1].
