...
.What's next?
After cabling node1 for shared cluster-HA and storage, link:boot-node1-with-a900-controller-and-nvs.html[boot node1 with the replacement system modules].
