...
---
= Install the AFF A90 or AFF A70 module in node2
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Install the AFF A90 or AFF A70 controller module that you received for the upgrade in node2. Node2 is controller B located on the lower bay of the chassis when looking at the controllers from the rear of the system.
