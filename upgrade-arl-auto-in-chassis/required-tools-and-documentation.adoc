...
Refer to link:other-references.html[References] to access the list of reference documents and reference sites required for this upgrade.

.What's next?
After reviewing the required tools and documentation, link:guidelines-for-upgrading-controllers-with-arl.html[learn about the guidelines for upgrading controllers].
