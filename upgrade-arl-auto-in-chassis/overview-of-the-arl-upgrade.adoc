...
| link:verify-upgrade-hardware.html[Stage 1: Prepare for upgrade]
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html[Stage 2: Relocate resources and retire node1]
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html[Stage 4: Relocate resources and retire node2]
...
| link:cable-node2-for-shared-cluster-HA-storage.html[Stage 6: Boot node2 with the replacement system modules]
