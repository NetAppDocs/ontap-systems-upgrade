...
.What's next?
After relocating non-root aggregates and NAS data LIFs from node2 to node1, link:relocate-failed-or-vetoed-aggr-node1.html[relocate failed or vetoed aggregates to node1].
