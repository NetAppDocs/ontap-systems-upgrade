...
summary: "Replace the node2 system modules during an ARL upgrade of controller models in the same chassis."
---
...
.What's next?
After installing the ASA A150, AFF A150, or FAS2820 controller module in node2, link:netboot-node2.html[netboot node2].
