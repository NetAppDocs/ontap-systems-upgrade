...
.What's next?
After moving non-root aggregates and NAS data LIFs back to node2, link:manage-authentication-using-kmip-servers.html[manage authentication using KMIP servers].
