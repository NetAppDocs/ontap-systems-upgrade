...
If you're upgrading to a two-node switchless cluster configuration, you can skip this section and go to link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html[Move non-root aggregates and NAS data LIFs back to node2].
...
| `Up`
| Go to link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html[Move non-root aggregates and NAS data LIFs back to node2].
| `Down`
...
.What's next?
After verifying the RCF configuration link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html[move non-root aggregates and NAS data LIFs back to node2].
