...
---
= Replace node1 AFF A800 or AFF C800 controller module
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
If you do not interrupt AUTOBOOT on time and node1 starts booting, wait for the prompt and enter Ctrl-C to go into the boot menu. After the node stops at the boot menu, use option `8` to reboot the node and interrupt AUTOBOOT during reboot.
...
.What's next?
After installing the AFF A90, AFF A70, or AFF C80 controller module, link:netboot-node1.html[netboot node1].
