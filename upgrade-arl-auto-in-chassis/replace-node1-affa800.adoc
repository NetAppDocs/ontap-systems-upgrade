...
---
= Replace the AFF A800 or AFF C800 controller module
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Replace the AFF A800 or AFF C800 controller module with an AFF A90, AFF A70, or AFF C80 controller module.
