...
summary: When using ARL to upgrade controller models in the same chassis, you must netboot node2 after swapping the corresponding replacement system module.
---
= Netboot node2
:hardbreaks:
:nofooter:
...
.What's next?
After netbooting node2, link:cable-node2-for-shared-cluster-HA-storage.html[cable node2 for shared cluster-HA and storage].
