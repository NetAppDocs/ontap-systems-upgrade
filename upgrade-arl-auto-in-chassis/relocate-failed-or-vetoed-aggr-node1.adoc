...
summary: "Manually relocate failed or vetoed aggregates to node1 when upgrading to controllers introdued  ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
