...
summary: "Manually relocate failed or vetoed aggregates to node1 when upgrading controllers introducced ONTAP 9.15.1 or later by using `system controller replace` commands."
---
