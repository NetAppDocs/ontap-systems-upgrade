...
summary: "Manually relocate failed or vetoed aggregates to node1 when upgrading to controllers introducced ONTTAP 9.15.1 or later by using `system controller replace` commands."
---
...
.What's next?
After relocating failed or vetoed aggregates to node1, link:retire-node2.html[retire node2].
