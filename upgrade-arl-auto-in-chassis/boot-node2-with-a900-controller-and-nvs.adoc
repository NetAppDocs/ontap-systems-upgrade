...
[.lead]
Node2 with the replacement modules is now ready to boot. The supported replacement modules are listed in the link:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis,[supported systems matrix].
