...
summary: "Install the replacement system modules in node2 during an ARL upgrade of controller models in the same chassis."
---
= Install the ASA A150, AFF A150, or FAS2820 controller module in node2
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Install the ASA A150, AFF A150, or FAS2820 controller module that you received for the upgrade in node2. Node2 is controller B located on the right side of the chassis when looking at the controllers from the rear of the system.
