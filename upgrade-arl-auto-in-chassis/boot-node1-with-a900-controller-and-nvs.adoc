...
+
Enter the passphrase and the backup information that you recorded earlier in the procedure. See link:manage-storage-encryption-using-okm.html[Manage storage encryption using the Onboard Key Manager].
