...
---
= Replace node1 AFF A250 or AFF C250 controller module
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Replace the node1 AFF A250 or AFF C250 controller module with an AFF A30, AFF A50, AFF C30, or AFF C60 controller module.
...
To remove the node1 controller module, remove the cable management device and unlock the locking latches. Then, remove the controller module from the chassis.
...
.What's next?
After installing the AFF A30, AFF A50, AFF C30, or AFF C60 controller module, link:netboot-node1.html[netboot node1].
