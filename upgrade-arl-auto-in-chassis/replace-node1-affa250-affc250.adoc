...
---
= Replace the node1 AFF A250 or AFF C250 controller module
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
.What's next?
After replacing the node1 AFF A250 or AFF C250 controller module, link:netboot-node1.html[netboot node1].
