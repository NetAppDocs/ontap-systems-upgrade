...
---
= Replace node1 AFF A220, AFF A200, AFF C190, FAS2620, or FAS2720 controller module
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Replace the node1 AFF A220, AFF A200, AFF C190, FAS2620, or FAS2720 controller module with an ASA A150, AFF A150, or FAS2820 controller module.
...
To access components inside the node1 controller, remove the controller module from the system and then remove the cover on the controller module.
...
. After you interrupt AUTOBOOT, node1 stops at the LOADER prompt. If you do not interrupt AUTOBOOT on time and node1 starts booting, wait for the prompt and enter Ctrl-C to go into the boot menu. After the node stops at the boot menu, use option `8` to reboot the node and interrupt AUTOBOOT during reboot.
...
.What's next?
After installing the ASA A150, AFF A150, or FAS2820 controller module, link:netboot-node1.html[netboot node1].
