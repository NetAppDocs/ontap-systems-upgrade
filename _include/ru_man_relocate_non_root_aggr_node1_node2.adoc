...
. [[relocate-step1]]Relocate the non-root aggregates by completing the following substeps:
...
Refer to link:other_references.html[References] to link to the _Disk and aggregate management with the CLI_ content and the _ONTAP 9 Command reference_ for more information about storage aggregate relocation commands.
|===
