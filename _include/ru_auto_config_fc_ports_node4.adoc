...
You can skip this section if your system does not have FC configurations. If your system has onboard UTA/UTA2 ports or a UTA/UTA2 adapter, you configure them in <<check-config-uta-uta2-node4,Check and configure UTA/UTA2 ports on node4>>.
