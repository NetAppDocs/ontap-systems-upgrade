...
You might need to complete <<configure-fc-ports-on-node3,Configure FC ports on node3>>, or <<check-config-uta-uta2-node3,Check and configure UTA/UTA2 ports on node3>>, or both sections.
