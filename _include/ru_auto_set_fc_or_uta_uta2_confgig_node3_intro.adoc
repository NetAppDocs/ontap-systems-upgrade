...
You might need to complete the section <<configure-fc-ports-on-node3,Configure FC ports on node3>>, the section <<check-config-uta-uta2-node3,Check and configure UTA/UTA2 ports on node3>>, or both sections.
