If any aggregates fail to relocate or are vetoed, you must manually relocate the aggregates to node2, or if necessary, override either the vetoes or destination checks.
