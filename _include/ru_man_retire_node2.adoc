...
. After node2 shuts down completely, remove it from the chassis or the rack. 

. Optionally, decommission node2 after the upgrade is completed. See link:decommission_old_system.html[Decommission the old system].
