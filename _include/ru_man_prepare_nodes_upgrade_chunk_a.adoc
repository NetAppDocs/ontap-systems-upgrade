...
+
For detailed information about the `network interface revert` command, refer to link:other_references.html[References] to link to the _ONTAP 9 Command reference_.
