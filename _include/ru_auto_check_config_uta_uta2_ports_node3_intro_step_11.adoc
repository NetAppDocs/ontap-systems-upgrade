...
+
WARNING: If your system has storage disks, you enter the commands in this section at the cluster prompt unless directed to enter Maintenance mode. You must be in Maintenance mode to configure UTA/UTA2 ports.
