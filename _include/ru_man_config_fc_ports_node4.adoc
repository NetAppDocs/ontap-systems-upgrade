...
* Skip the section _Check and configure UTA/UTA2 ports on node4_ if node4 does not have a UTA/UTA2 card or UTA/UTA2 onboard ports, return to the section _Install and boot node4_, and resume the section at link:install_boot_node4.html#man_install4_Step9[Step 9].
|===
