...
|link:https://docs.netapp.com/us-en/ontap-cli/index.html[ONTAP 9 Command reference^]
|Describes the syntax and usage of supported ONTAP commands.
...
|link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html[Use "system controller replace" commands to upgrade to controller hardware introduced in ONTAP 9.15.1 and later^]
|Describes the aggregate relocation procedures needed to non-disruptively upgrade to controllers introduced in ONTAP 9.15.1 and later by using "system controller replace" commands.
|link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-in-chassis/index.html[Use "system controller replace" commands to upgrade controller models in the same chassis^]
