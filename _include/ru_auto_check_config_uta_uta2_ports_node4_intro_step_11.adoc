...
== Step 2: Check and configure UTA/UTA2 ports on node4
...
|Skip Step 5 through Step 9 and go to <<auto_check_4_step10,Step 10>>.
...
|Go to <<auto_check_4_step6,Step 6>>
|Onboard UTA/UTA2 ports
|Skip Step 6 and go to <<auto_check_4_step7,Step 7>>.
|===

. [[auto_check_4_step6]]If the adapter is in initiator mode, and if the UTA/UTA2 port is online, take the UTA/UTA2 port offline:
+
