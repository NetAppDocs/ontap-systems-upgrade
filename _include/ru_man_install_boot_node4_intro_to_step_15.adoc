...
[IMPORTANT]
====
* If you upgrading an AFF A700, AFF A800, or AFF C800 controller, you must ensure that all drives in the chassis are firmly seated against the midplane before removing node2. You do this from the front of the chassis by using your thumbs to push each drive until you feel a positive stop. 
