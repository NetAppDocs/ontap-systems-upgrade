...
+
VLANs are configured over physical ports. If the physical ports change, then the VLANs need to be re-created later in the procedure.
+
...
+
If neither iSCSI nor FC is configured for the SVM, the command displays a message similar to the following example:
+
....
...
+
If either iSCSI or FC is configured for the SVM, the command displays a message similar to the following example:
+
....
...
....
+
Nodes in a cluster are in quorum when a simple majority of nodes are healthy and can communicate with each other. For more information, refer to link:other-references.html[References] to link to the _System Administration Reference_.
...
For detailed information about the SP, refer to link:other-references.html[References] to link to the _System Administration Reference_ and the _ONTAP 9 Command reference_.
...
. Obtain new license keys for the new nodes at the  _NetApp Support Site_. Refer to link:other-references.html[References] to link to _NetApp Support Site_.
+
...
a|Enable AutoSupport by following the instructions in the _System Administration Reference_. (Refer to link:other-references.html[References] to link to the _System Administration Reference_.)
...
+
For detailed information about AutoSupport, refer to link:other-references.html[References] to link to the _System Administration Reference_ and the _ONTAP 9 Command reference_.
